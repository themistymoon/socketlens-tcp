...
| ชุดทดสอบอัตโนมัติ 598 ข้อ           | ความถูกต้องของโพรโทคอลที่ขอบเขตของกรณีต่าง ๆ          |
...
| 5    | `--scenario fragmentation` แล้วใส่ตัวกรอง `tcp.len > 0` นับเซกเมนต์ | "เขียน 6 ครั้ง แต่จำนวนเซกเมนต์ที่เห็นเป็นเรื่องที่ระบบปฏิบัติการตัดสิน"      |
...
"ในสถานการณ์การแบ่งข้อความ โปรแกรมเรียก `socket.write()` หกครั้ง — นั่นเป็นข้อเท็จจริงของ
...
**ต้องระวังไม่พูดผิด** อย่าพูดว่า "เขียนเจ็ดครั้งคือเจ็ดแพ็กเก็ต" เพราะไม่จริง
และกรรมการที่รู้เรื่อง TCP จะจับได้ทันที

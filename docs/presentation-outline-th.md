...
- [x] **เปิด Wireshark เห็น "Adapter for loopback traffic capture" ในรายการอินเทอร์เฟซ**
- [x] **ทดสอบ `npm run wireshark:demo -- --scenario ping` แล้วเห็นแพ็กเก็ตใน Wireshark จริง**
- [x] **บันทึกไฟล์ `.pcapng` สำรองไว้แล้ว เผื่อการจับแพ็กเก็ตสดล้มเหลว**
...
- [x] เตรียมภาพหน้าจอสำรองไว้ 11 ภาพใน `evidence/wireshark-2026-08-29/` — รายละเอียดอยู่ใน [wireshark-capture.md](wireshark-capture.md) หัวข้อที่ 10
